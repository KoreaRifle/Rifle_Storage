...
//		cout << "착용가능직업 : ";
//		if (_vinven->role == ITEMROLE::WARRIOR) cout << "전사" << endl;
//		else if (_vinven->role == ITEMROLE::WIZARD) cout << "마법사" << endl;
//		else if (_vinven->role == ITEMROLE::ELF) cout << "엘프" << endl;
...
//		if (_vinven->req_level != 0) cout << "착용제한 레벨 : " << _vinven->req_level << endl;
//		if (_vinven->req_pwr != 0) cout << "착용제한 힘 : " << _vinven->req_pwr << endl;
//		if (_vinven->req_dex != 0) cout << "착용제한 민첩 : " << _vinven->req_dex << endl;
//		if (_vinven->req_intel != 0) cout << "착용제한 지능 : " << _vinven->req_intel << endl;
//		cout << "====================" << endl;
//		itemNum++;
//	}
//}
